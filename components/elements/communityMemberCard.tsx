...
export function CommunityMemberCard({member, focusable}:{member: any, focusable?: boolean}) {
    ...
    return (
        <>
        <div className={`${(active && focusable) ? 'z-20 fixed left-0 right-0 top-[15vh] md:top-[40vh]' : 'hidden'} mx-auto w-56 h-fit flex flex-col place-items-center`} onClick={() => setActive(true)}>
            ...
            <div className="bg-white p-5 pt-16 w-[150%] border border-black h-fit" style={{boxShadow: '4px 4px 0 #ff1616, -4px -4px 0 #cfff00'}}>
