...
export function CommunityMemberCard({member, focusable}:{member: any, focusable?: boolean}) {
    ...
    return (
        <>
        <div className={`${(active && focusable) ? 'z-20 fixed left-0 right-0 top-[40vh]' : 'hidden'} mx-auto w-56 h-fit grid justify-items-center`} style={{boxShadow: '4px 4px 0 #ff1616, -4px -4px 0 #cfff00'}} onClick={() => setActive(true)}>
            <div className="aspect-square border border-black w-56 relative -mb-10">
