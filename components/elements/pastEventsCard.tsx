        ...
        <>
            ...
            {event.type === 'recap' &&
                <div className="bg-black text-white font-body m-10 text-sm overflow-clip rounded-3xl py-5 md:p-5">
                    ...
                    <div className="my-5 md:m-5 aspect-video">
                        <iframe width="100%" height="100%" src={event.video} title={event.date} frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share;" allowFullScreen={true} />
                    </div>
                </div>
            }
        </>
