...
export default function CallToAction() {
    return (
      <section className="bg-black rounded-xl mx-5 px-5 py-10 max-w-4xl md:mx-auto md:mb-10">
        ...
        <div className="md:flex md:gap-10 md:mx-5">
          ...
          <img className="rounded-xl mt-10 max-w-xs" src="/images/placeholders/cta_picture.jpeg" />
        </div>
      </section>
    )
  }
